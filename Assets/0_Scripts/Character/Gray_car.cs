...
public class Gray_car : Car_core
{
    ...
    protected override void Init_values()
    {
        ...
        {
            m_pos_arr[i] = npc_manager.gray_car_pos_list[i];
        }
    }
