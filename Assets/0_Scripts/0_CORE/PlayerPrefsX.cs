...
public class PlayerPrefsX
{
	...
	enum e_array_type { Float, Int32, Bool, String, Vector2, Vector3, Quaternion, Color }
	...
	public static bool SetBoolArray(String key, bool[] boolArray)
	{
		...
		bytes[0] = System.Convert.ToByte(e_array_type.Bool);   // Identifier
	...
	public static bool[] GetBoolArray(String key)
	{
		if (PlayerPrefs.HasKey(key))
		{
			...
			if ((e_array_type)bytes[0] != e_array_type.Bool)
			{
	...
	public static bool SetStringArray(String key, String[] stringArray)
	{
		...
		bytes[0] = System.Convert.ToByte(e_array_type.String); // Identifier
		Initialize();
	...
	public static String[] GetStringArray(String key)
	{
		if (PlayerPrefs.HasKey(key))
		{
			...
			if ((e_array_type)bytes[0] != e_array_type.String)
			{
	...
	{
		return SetValue(key, intArray, e_array_type.Int32, 1, ConvertFromInt);
	}

	public static bool SetFloatArray(String key, float[] floatArray)
	{
		return SetValue(key, floatArray, e_array_type.Float, 1, ConvertFromFloat);
	}

	public static bool SetVector2Array(String key, Vector2[] vector2Array)
	{
		return SetValue(key, vector2Array, e_array_type.Vector2, 2, ConvertFromVector2);
	}

	public static bool SetVector3Array(String key, Vector3[] vector3Array)
	{
		return SetValue(key, vector3Array, e_array_type.Vector3, 3, ConvertFromVector3);
	}

	public static bool SetQuaternionArray(String key, Quaternion[] quaternionArray)
	{
		return SetValue(key, quaternionArray, e_array_type.Quaternion, 4, ConvertFromQuaternion);
	}

	public static bool SetColorArray(String key, Color[] colorArray)
	{
		return SetValue(key, colorArray, e_array_type.Color, 4, ConvertFromColor);
	}

	private static bool SetValue<T>(String key, T array, e_array_type arrayType, int vectorNumber, Action<T, byte[], int> convert) where T : IList
	{
	...
	public static int[] GetIntArray(String key)
	{
		...
		GetValue(key, intList, e_array_type.Int32, 1, ConvertToInt);
	...
	public static float[] GetFloatArray(String key)
	{
		...
		GetValue(key, floatList, e_array_type.Float, 1, ConvertToFloat);
	...
	public static Vector2[] GetVector2Array(String key)
	{
		...
		GetValue(key, vector2List, e_array_type.Vector2, 2, ConvertToVector2);
	...
	public static Vector3[] GetVector3Array(String key)
	{
		...
		GetValue(key, vector3List, e_array_type.Vector3, 3, ConvertToVector3);
	...
	public static Quaternion[] GetQuaternionArray(String key)
	{
		...
		GetValue(key, quaternionList, e_array_type.Quaternion, 4, ConvertToQuaternion);
	...
	public static Color[] GetColorArray(String key)
	{
		...
		GetValue(key, colorList, e_array_type.Color, 4, ConvertToColor);
	...
	private static void GetValue<T>(String key, T list, e_array_type arrayType, int vectorNumber, Action<T, byte[]> convert) where T : IList
	{
		if (PlayerPrefs.HasKey(key))
		{
			var bytes = System.Convert.FromBase64String(PlayerPrefs.GetString(key));
			...
			if ((e_array_type)bytes[0] != arrayType)
			{
	...
	public static void ShowArrayType(String key)
	{
		...
		if (bytes.Length > 0)
		{
			e_array_type arrayType = (e_array_type)bytes[0];
