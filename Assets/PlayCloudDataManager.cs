...
public class PlayCloudDataManager
{

    private static PlayCloudDataManager _instance;
    public static PlayCloudDataManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = new PlayCloudDataManager();
            }
            return _instance;
        }
    }
    ...
    public void ProcessCloudData(byte[] cloudData)
    {
        if (cloudData == null)
        {
    ...
    public void MergeWith(string other)
    {
        if (other != "")
        {
            saveString = other;
